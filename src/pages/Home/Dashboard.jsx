...
const Dashboard = () => {
  ...
  return <DashboardLayout>
    <div className="grid grid-cols-1 md:grid-cols-5 gap-4 md:gap-7 pt-1 pb-6 px-4 md:px-0">
      <div
        className="h-[300px] flex flex-col gap-5 items-center justify-center bg-white rounded-lg border border-emerald-100 hover:border-emerald-300 hover:bg-emerald-50/5 cursor-pointer"
        onClick={() => setOpenCreateModal(true)}
      >
        <div className="w-12 h-12 flex items-center justify-center bg-emerald-200/60 rounded-2xl">
          <CirclePlus className="text-xl text-emerald-500" />
        </div>
